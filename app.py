...
if page == "📈 Insights Dashboard":
    ...
    #Relationship between trader behaviour
    ...
    # Relationship between Market sentiment and trading 
    ...
    #PnL Boxplot by Sentiment Class
    ...
    ax6.set_xlabel("Trade Date")
    ax6.set_ylabel("rolling_pnl")
    st.pyplot(fig6)
    ...
    if submit:
        ...
        feature_cols = ['value', 'total_trades', 'avg_trade_size', 'total_fees', 'win_ratio']
        clf_df = merged_df.dropna(subset=feature_cols + ['pnl_class'])
